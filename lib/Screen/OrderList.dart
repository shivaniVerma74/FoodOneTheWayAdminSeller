...
class _OrderListState extends State<OrderList> with TickerProviderStateMixin {
  ...
  orderItem(int index) {
    ...
    // String storeName = '';
    // for(var i=0;i<)
    return  model.itemList!.isNotEmpty ? Card(
      elevation: 0,
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Store name",style: TextStyle(color: Colors.grey),),
                    Container(
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Seller contact",style: TextStyle(color: Colors.grey),),
                    InkWell(
                        onTap: () {
                          _launchCaller(index);
                        },
                        child: Row(
                          children: [
                            ...
                            Text("${model.itemList![0].sellerMobile}",
                              style: TextStyle(
                                  color: black,
                                  decoration: TextDecoration.underline),
                            ),
