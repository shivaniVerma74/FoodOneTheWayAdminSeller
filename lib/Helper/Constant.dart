final String appName = 'Food On The Way Admin';

final String packageName = 'com.foodontheway.admin';

final String iosPackage = 'com.foodontheway.admin';
// https://alphawizztest.tk/Food_on_the_way/app/v1/api/
// final String baseUrl = 'https://foodontheways.com/seller/app/v1/api/';
final String baseUrl = 'https://foodontheways.com/admin/app/v1/api/';
// final String baseUrl = 'https://foodontheways.com/admin/app/v1/api/';
