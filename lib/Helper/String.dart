...
final Uri getAdminTransactionApi = Uri.parse(baseUrl + 'get_transactions');
final Uri getDriverTransactionApi = Uri.parse(baseUrl + 'get_transactions_driver');
final Uri getSellerTransactionApi = Uri.parse(baseUrl + 'get_transactions_seller');
